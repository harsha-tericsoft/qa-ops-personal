...
- Name: tests\phase-2-ui-verification.spec.ts >> Phase 2 UI Verification - Test Cases Page >> 9. Test grid displays test data correctly
- Location: tests\phase-2-ui-verification.spec.ts:302:7
...
Call log:
  - waiting for locator('table, [role="grid"]').first()
