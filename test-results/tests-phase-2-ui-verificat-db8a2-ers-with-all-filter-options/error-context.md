...
- Name: tests\phase-2-ui-verification.spec.ts >> Phase 2 UI Verification - Test Cases Page >> 3. Filter panel renders with all filter options
- Location: tests\phase-2-ui-verification.spec.ts:108:7
...
Call log:
  - waiting for locator('h2:has-text("Filters")').locator('..').locator('..')
