...
- Name: tests\phase-2-ui-verification.spec.ts >> Phase 2 UI Verification - Test Cases Page >> 1. Page loads and displays summary cards
- Location: tests\phase-2-ui-verification.spec.ts:41:7
...
Expected substring: "Test Cases"
Received string:    "QA Ops Platform"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h1').first()
    14 × locator resolved to <h1 class="text-xl font-bold text-gray-900">QA Ops Platform</h1>
       - unexpected value "QA Ops Platform"
